...
export type ImageCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']>;
  job?: InputMaybe<ImageJobCreateOneInlineInput>;
...
export type ImageJob = Job;

export type ImageJobConnectInput = {
...
export type ImageJobCreateManyInlineInput = {
  /** Connect multiple existing ImageJob documents */
  connect?: InputMaybe<Array<ImageJobWhereUniqueInput>>;
  /** Create and connect multiple existing ImageJob documents */
  create?: InputMaybe<Array<ImageJobCreateInput>>;
};

export type ImageJobCreateOneInlineInput = {
  /** Connect one existing ImageJob document */
  connect?: InputMaybe<ImageJobWhereUniqueInput>;
  /** Create and connect one ImageJob document */
  create?: InputMaybe<ImageJobCreateInput>;
};
...
export type ImageJobUpdateManyInlineInput = {
  /** Connect multiple existing ImageJob documents */
  connect?: InputMaybe<Array<ImageJobConnectInput>>;
  /** Create and connect multiple ImageJob documents */
  create?: InputMaybe<Array<ImageJobCreateInput>>;
  /** Delete multiple ImageJob documents */
  delete?: InputMaybe<Array<ImageJobWhereUniqueInput>>;
  /** Disconnect multiple ImageJob documents */
  disconnect?: InputMaybe<Array<ImageJobWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing ImageJob documents */
  set?: InputMaybe<Array<ImageJobWhereUniqueInput>>;
  /** Update multiple ImageJob documents */
  update?: InputMaybe<Array<ImageJobUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple ImageJob documents */
  upsert?: InputMaybe<Array<ImageJobUpsertWithNestedWhereUniqueInput>>;
};

export type ImageJobUpdateManyWithNestedWhereInput = {
  Job?: InputMaybe<JobUpdateManyWithNestedWhereInput>;
};

export type ImageJobUpdateOneInlineInput = {
  /** Connect existing ImageJob document */
  connect?: InputMaybe<ImageJobWhereUniqueInput>;
  /** Create and connect one ImageJob document */
  create?: InputMaybe<ImageJobCreateInput>;
  /** Delete currently connected ImageJob document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected ImageJob document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single ImageJob document */
  update?: InputMaybe<ImageJobUpdateWithNestedWhereUniqueInput>;
  /** Upsert single ImageJob document */
  upsert?: InputMaybe<ImageJobUpsertWithNestedWhereUniqueInput>;
};

export type ImageJobUpdateWithNestedWhereUniqueInput = {
  Job?: InputMaybe<JobUpdateWithNestedWhereUniqueInput>;
};

export type ImageJobUpsertWithNestedWhereUniqueInput = {
...
export type ImageJobWhereUniqueInput = {
...
export type ImageUpdateInput = {
  job?: InputMaybe<ImageJobUpdateOneInlineInput>;
  source?: InputMaybe<Scalars['String']>;
};
...
export type ScheduledOperationAffectedDocument = Asset | Challenge | Image | Job | Subscriber | Teacher;
...
export type GetJobBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetJobBySlugQuery = {
   __typename?: 'Query', 
   job: { 
    __typename?: 'Job', 
    title: string, 
 ...
 * });
 */
export function useGetJobBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetJobBySlugQuery, GetJobBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetJobBySlugQuery, GetJobBySlugQueryVariables>(GetJobBySlugDocument, options);
      }
export function useGetJobBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetJobBySlugQuery, GetJobBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetJobBySlugQuery, GetJobBySlugQueryVariables>(GetJobBySlugDocument, options);
        }
...
export type GetJobBySlugQueryResult = Apollo.QueryResult<GetJobBySlugQuery, GetJobBySlugQueryVariables>;